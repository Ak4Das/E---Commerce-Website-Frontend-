...
export default function PaymentMethods() {
  ...
  const product = JSON.parse(localStorage.getItem("clothsData")).find(
    (product) => product.id === id
  )

  function createOrder() {
    const order = { itemId:id, address, paymentMethod,itemPrice:product.price,delivery:30 }
    orders.push(order)
      ...
      <main className="container mt-3 d-lg-flex gap-5 align-items-start">
        ...
        <section className="bg-light p-3 paymentMethodSectionTwo mt-5 mt-lg-0 position-sticky top-0">
          <div>
            ...
            <p className="my-0 w-50 fw-medium d-inline-block text-end">₹{product.price}</p>
          </div>
          <div>
            <p className="my-0 w-50 fw-medium d-inline-block">Delivery: </p>
            <p className="my-0 w-50 fw-medium d-inline-block text-end">₹30</p>
          </div>
          <div>
            <p className="my-0 w-50 fw-medium d-inline-block">Total: </p>
            <p className="my-0 w-50 fw-medium d-inline-block text-end">₹{product.price + 30}</p>
          </div>
          <div>
            <p className="my-0 w-50 fw-medium d-inline-block text-success">
              Free Delivery:{" "}
            </p>
            <p className="my-0 w-50 fw-medium d-inline-block text-end text-success">₹0</p>
          </div>
          <hr />
          <div>
